...
https://rgbd.cs.princeton.edu/paper.pdf
In this repo the official SUN-RGBD Dataset has been modified such that it can be used for training VoteNet/ImVoteNet
